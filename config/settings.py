...
SECRET_KEY = "django-insecure-#*bo#nt!@tvp&8y=&&3pe-$)&$_88evx1n)iso^sjo8qhew$&)"
...
# Crispy Forms 설정
CRISPY_TEMPLATE_PACK = "bootstrap4"  # Bootstrap 을 사용하는 경우
CRISPY_ALLOWED_TEMPLATE_PACKS = "bootstrap4"


# Markdownx 설정
MARKDOWNX_UPLOAD_MAX_SIZE = 50 * 1024 * 1024  # 50MB - 최대 업로드 크기
